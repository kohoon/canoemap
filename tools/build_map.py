...
<style>
  ...
  .addr-drag-handle{display:flex;align-items:center;justify-content:center;gap:6px;margin:-5px 22px 8px -2px;padding:5px 8px;border-radius:7px;background:#eef3f5;color:#60747d;font:700 10.5px/1 sans-serif;letter-spacing:-.1px;cursor:grab;user-select:none;touch-action:none}
  .addr-drag-handle:active{cursor:grabbing;background:#e2ebef;color:#36515e}
  .addr-drag-grip{font-size:13px;letter-spacing:-3px;transform:rotate(90deg)}
...
async function showAddress(lat,lng){
  ...
  const grip='<div class="addr-drag-handle" role="button" aria-label="주소 카드 이동"><span class="addr-drag-grip">•••</span>끌어서 이동</div>';
