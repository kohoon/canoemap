...
const MODEL_Y_SVG='<svg viewBox="0 0 72 44" aria-label="Tesla Model Y"><path d="M18 5Q36-1 54 5L61 12Q66 16 67 23L66 35Q65 40 60 41H12Q7 40 6 35L5 23Q6 16 11 12Z" fill="#f8fafc" stroke="#1f3444" stroke-width="2"/><path d="M22 7Q36 3 50 7L55 15H17Z" fill="#263f52"/><path d="M17 17H55L59 31H13Z" fill="#dbe8ef"/><path d="M30 18H42V31H30Z" fill="#21394b" opacity=".9"/><path d="M7 22H13M59 22H65" stroke="#90caf9" stroke-width="3" stroke-linecap="round"/><path d="M12 35H60" stroke="#8aa0ad" stroke-width="2"/><rect x="7" y="15" width="5" height="10" rx="2" fill="#263238"/><rect x="60" y="15" width="5" height="10" rx="2" fill="#263238"/></svg>';
