...
async function showAddress(lat,lng){
  ...
  const pop=L.popup({offset:L.point(0,-52),keepInView:true,autoPanPadding:[18,18]}).setLatLng([lat,lng]).setContent(grip+'주소 조회 중…').openOn(map);enableAddressPopupDrag(pop);
