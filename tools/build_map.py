...
// ---- 내 위치 ----
let _locMarker=null, _locCircle=null, _locWatching=false, _locHasFix=false;
...
function _setLocateState(active,loading){
  ...
  b.title=active?'실시간 위치 추적 중 · 지도를 끌면 종료':'내 위치';
}
...
map.on('locationfound', function(e){
  ...
  else _locMarker=L.marker(e.latlng,{icon:L.divIcon({className:'loc-canoe',html:'<span class="loc-canoe-in">'+CANOE_SVG+'</span>',iconSize:[40,40],iconAnchor:[20,20]}),zIndexOffset:1000,interactive:false}).addTo(map);
